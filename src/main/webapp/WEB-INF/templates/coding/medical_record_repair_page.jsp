...
<script type="text/javascript" src="${basePath}assets/js/coding/medical_record_repair_page.js"></script>
<style type="text/css">
.error_msg {
...
<div class="loc">
	<h3>病案返修</h3>
	<ul class="loc_loc"><li> 当前位置：病案编码 > 病案返修</li>
	</ul>
</div>
 ...
 <table style="width:934px; float:left; border-collapse:collapse;" id="query_show_table">
      <thead>
	      <tr>
		      ...
		      <td class="tdLabel_4" style="width: 150px;">错误描述</td>
      ...
      <tbody>
	      ...
	      <td class="tdLabel_5"><span class="error_msg"></span></td>
	      <td class="tdLabel_5">
	      	<a class="operate" onclick="pageIndexCoding(this)" title="返修">返修&nbsp;</a>
	      </td>
	     </tr>
      </tbody>
     </table>
