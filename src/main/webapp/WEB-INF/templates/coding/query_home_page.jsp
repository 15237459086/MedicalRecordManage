...
<script type="text/javascript" src="${basePath}assets/js/coding/query_home_page.js"></script>


<div class="loc">
	<h3>首页编码</h3>
	<ul class="loc_loc"><li> 当前位置：病案编码 > 首页编码</li>
	</ul>
</div>
<div class="list_con_table">
 ...
 <table style="width:934px; float:left; border-collapse:collapse;" id="query_show_table">
      ...
      <tbody>
	      ...
	      <td class="tdLabel_5">
	      	<a class="operate" onclick="pageIndexCoding(this)" title="首页编码">首页编码&nbsp;</a>&nbsp;/&nbsp;
	      	<a onclick="pageIndexShow(this)" title="首页预览">首页预览&nbsp;</a>
	      </td>
	     </tr>
      </tbody>
     </table>
