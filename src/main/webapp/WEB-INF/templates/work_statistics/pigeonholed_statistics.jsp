...
<script type="text/javascript" src="${basePath}assets/js/work_statistics/pigeonholed_statistics.js"></script>
<div class="loc">
	<h3>编页统计</h3>
	<ul class="loc_loc"><li> 当前位置：工作统计 > 编页统计</li>
	</ul>
</div>
 ...
 <table style="width:934px; float:left; border-collapse:collapse;" id="query_show_table">
      <thead>
	      <tr>
		      ...
		      <td class="tdLabel_4">应编页总数</td>
		      <td class="tdLabel_4">已编页总数</td>
		      <td class="tdLabel_4">编页率</td>
      ...
      <tbody>
	      ...
	      <td class="tdLabel_5" rowspan="2"><span class="imageCountOfShouldPigeonholed"></span></td>
	      <td class="tdLabel_5" rowspan="2"><span class="imageCountOfPigeonholed"></span></td>
	      <td class="tdLabel_5" rowspan="2"><span class="pigeonholedRate"></span></td>
	      <td class="tdLabel_5"><span class="create_user_name"></span></td>
	      <td class="tdLabel_5"><span class="count"></span></td>
	      <td class="tdLabel_5"><span class="imageCountRate"></span></td>
	    </tr>
      	<!-- <tr>
	      <td class="tdLabel_5"><span>李龙</span></td>
	      <td class="tdLabel_5"><span>1</span></td>
	      <td class="tdLabel_5"><span>2.72</span></td>
	     </tr> -->
      </tbody>
     </table>