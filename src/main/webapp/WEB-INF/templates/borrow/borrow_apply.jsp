...
<script type="text/javascript" src="${basePath}assets/js/borrow/borrow_apply.js"></script>


<div class="loc">
	<h3>借阅申请</h3>
	<ul class="loc_loc"><li> 当前位置：病案借阅 > 借阅申请</li>
	</ul>
</div>
<div class="list_con_table">
 ...
 <table style="width:934px; float:left; border-collapse:collapse;" id="query_show_table">
      ...
      <tbody>
	      ...
	      <td class="tdLabel_5"><a class="operate" title="申请借阅">申请借阅&nbsp;</a></td>
	     </tr>
