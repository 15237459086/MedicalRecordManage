...
<script type="text/javascript" src="${basePath}assets/js/borrow/borrow_record.js"></script>


<div class="loc">
	<h3>借阅记录</h3>
	<ul class="loc_loc"><li> 当前位置：病案借阅 > 借阅记录</li>
	</ul>
</div>
<div class="list_con_table">
 ...
 <table style="width:934px; float:left; border-collapse:collapse;" id="query_show_table">
      ...
      <tbody>
	      ...
	      <td class="tdLabel_5"><span class="borrow_status"></span></td>
	      <td class="tdLabel_5"><span class="validity_date_format"></span></td>
	      
	      <td class="tdLabel_5"><a class="operate" onclick="showBorrow(this)" title="病案预览">病案预览&nbsp;</a></td>
	     </tr>
