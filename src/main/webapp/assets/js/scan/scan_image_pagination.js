...
function imagePagination(obj){
	var basePath = $("#basePath").val();
	 var content = $(obj).parent().parent();
	 var visitGuid = content.attr("id");
	window.open(basePath+'medical_record_scan/image_pagination?visitGuid='+visitGuid);
}

function showImagePagination(obj){
	var basePath = $("#basePath").val();
	 var content = $(obj).parent().parent();
	 var visitGuid = content.attr("id");
	window.open(basePath+'medical_record_scan/show_image_pagination?visitGuid='+visitGuid);
}
